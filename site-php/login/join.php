...
<body>
    ...
    <div id="skip">
        <a href="../pages/join.php">회원가입 바로가기</a>
                            ...
                            <fieldset>
                                ...
                                <div class="member-box">
                                    ...
                                    <div>
                                        ...
                                        <input type="password" name="youPassC" id="youPassC" class="input_write" maxlength="20" placeholder="다시 한번 비밀번호를 적어주세요!" autocomplete="off">
                                    </div>
                                    <div>
                                        <label for="youName">이름</label>
                                        <input type="text" name="youName" id="youName" class="input_write" maxlength="5" placeholder="이름을 적어주세요" autocomplete="off">
                                    </div>
                                    <div>
                                    ...
                                    <div>
                                        ...
                                        <input type="text" name="youPhone" id="youPhone" class="input_write" placeholder="000-0000-0000" autocomplete="off">
                                    </div>
                                </div>
                            </fieldset>
                            <button id="joinBtn" type="submit" class="btn_submit">회원가입 완료</button> <!--submit하면 위에 aciton주소로 넘어가게끔-->
                        </form>
                    </div>
                </article>
            </section>
